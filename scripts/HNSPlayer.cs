...
public class KillEffect : MyEffect
{
	...
	public override void OnEffectUpdate()
	{
		...
		UI.Text(timeLeftRect, $"You'll get revive as hunter in: {(int)DurationRemaining}", GameManager.Instance.GetTextSettings(60, 0f, null, UI.HorizontalAlignment.Center));
	}
}
